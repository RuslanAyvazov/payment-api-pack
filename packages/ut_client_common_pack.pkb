create or replace package body ut_client_common_pack is

  -- √енераци¤ значени¤ полей дл¤ сущности клиент
  ...
  begin
    -- если ничего не передано, то по умолчанию генерим какие-то значени¤
